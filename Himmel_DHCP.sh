#NOMOR1
#install isc-dhcp-server pada bashrc
...
subnet 192.215.4.0 netmask 255.255.255.0 {
    range 192.215.3.16 192.215.3.32;
    range 192.215.3.64 192.215.3.80;
    option routers 192.215.4.1;
    option broadcast-address 192.215.255;
    option domain-name-servers 192.215.2.3; 
    default-lease-time 180;
    max-lease-time 5760;
}

subnet 192.215.1.0 netmask 255.255.255.0 {
    range 192.215.4.12 192.215.4.20;
    range 192.215.4.160 192.215.4.168;
